...
class _CadastroState extends State<Cadastro> {
  ...
  TextEditingController _controllerNome = TextEditingController(text: 'Jonatas Caetano');
  TextEditingController _controllerEmail = TextEditingController(text: 'jonatas.calves@gmail.com');
